...
##** Pipeline for analysis of one RNA-seq data sample, from data filtering to alignement. The output generated from this bash script could be used directly as input in "featureCount"
